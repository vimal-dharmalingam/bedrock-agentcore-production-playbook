"""
Builds deployment_package.zip for Terraform's aws_lambda_function resource -- same approach
as 04-lambda/zip-deploy, x86_64 wheels prefetched with uv, no Docker involved.

Run from inside 04-lambda/terraform/, before `terraform apply`:
